// API functions for PCA (Principal Component Analysis) and other dimensionality reduction techniques
...
export interface PCAnalysisOptions {
  ...
  // Fix imports in existing components that might be affected
