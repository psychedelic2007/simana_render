...
const RMSDAnalysis = () => {
  ...
  const downloadPlot = async (plotId: string) => {
    ...
    try {
      ...
      const dataUrl = await Plotly.toImage(chartData, {format: 'png', width: 1200, height: 800});
              ...
              <Tabs defaultValue="lineChart">
                ...
                <TabsContent value="lineChart" className="space-y-4">
                  ...
                  <div>
                    ...
                    <select 
                      value={customizations.lineChart.legendPosition}
                      onChange={(e) => setCustomizations({
                        ...customizations,
                        lineChart: {
                          ...customizations.lineChart,
                          legendPosition: e.target.value as "top" | "bottom"
                        }
                      })}
                ...
                <TabsContent value="distribution" className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input 
                        ...
                        max={5} 
                        step={0.1}
                        value={customizations.distribution.lineWidth} 
                        onChange={(e) => setCustomizations({
                          ...customizations,
                          distribution: {
                            ...customizations.distribution,
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Fill Alpha</label>
                    <Input 
                      type="number"
                      min={0}
                      max={1}
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Legend Position</label>
                    <select 
                      value={customizations.distribution.legendPosition}
                      onChange={(e) => setCustomizations({
                        ...customizations,
                        distribution: {
                          ...customizations.distribution,
